...
/* Generated from ../O.Common/ics-dg-com.dbd */
...
int ics_dg_com_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/epics/iocs/vanilla/ics-dg-com";
...
/* ics_dg_com_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"ics_dg_com_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    ics_dg_com_registerRecordDeviceDriver(*iocshPpdbbase);
}
